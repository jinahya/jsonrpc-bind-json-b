...
public class JsonbJsonrpcRequestMessageService implements JsonrpcRequestMessageService {

    @Override
    public JsonrpcRequestMessage fromJson(final Object source) {
        requireNonNull(source, "source is null");
        return JsonbJsonrpcMessageServiceHelper.fromJson(source, JsonbJsonrpcRequestMessage.class);
    }
    ...
    public JsonrpcRequestMessage fromJsonString(final String string) {
        ...
        return getJsonb().fromJson(string, JsonbJsonrpcRequestMessage.class);
    }
