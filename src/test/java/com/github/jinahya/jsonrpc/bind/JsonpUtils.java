...
public final class JsonpUtils {
    ...
    public static JsonObject readJsonObjectFromResource(final Class<?> caller, final String name)
            throws IOException {
        return applyJsonReaderOfResource(caller, name, JsonReader::readObject);
    }

    public static JsonArray readJsonArrayFromResource(final Class<?> caller, final String name)
            throws IOException {
